...
import getRoadmap from "@/lib/actions/researchAgent";
import { useRouter } from "next/navigation";

import { useState } from "react";

export default function Generate(params: any) {
    const { mongoUserId } = params;
                    ...
                    <Button className=" bg-primary-500 hover:bg-primary-500/50" disabled={isGenerating}>
                        {
                            isGenerating ? (
                                <>
                                    ...
                                    <span className="paragraph-regular text-light-800">
