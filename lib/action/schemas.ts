  ...
  tutorials: z
    .array(
      z.object({
        title: z
          .string()
          .describe("this is the title for each topic of learning path"),
        tutorial: z
          .object({
            moduleOverview: z
              .string()
                ...
                z
                  .object({
                    ...
                    paragraph: z
                      .string()
                      .describe(
                        "A comprehensive paragrapph related to that heading"
                      ),
                    imgUrl: z
                      .string()
                      .describe(
            ...
            exampleCode: z.object({
              ...
              code: z.object({
                languageName: z
                  .string()
                  .describe(
                    "This property will contain the language of the code"
                  ),
                code: z
          ...
          .describe(
            "this object contains all the sections related to the heading"
          ),
      })
    )
    .describe(
      "the list of all the topics of learning path with its title and its detail"
    ),
});
